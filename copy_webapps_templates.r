...
library(httr)
dir_gh  = '~/github/arc/webapps_templates'
...
for (f in c('regions.brew.md',   # ohi-science.org/arc/regions -> renders with layers/rgn_labels.csv
            'layers.brew.md',    # ohi-science.org/arc/layers  -> renders with layers.csv
            'goals.brew.md',     # ohi-science.org/arc/goals   -> renders with conf/goals.Rmd
            'scores.brew.md'     # ohi-science.org/arc/scores  -> renders with scores.csv
)){
