####Artisinal Opportunities Mammals####
...
ico_list_raw <- read_csv(file.path('circle2016/prep/AO/mammals/ico_list_raw.csv'))
...
write_csv(ico_list, file.path('circle2016/prep/AO/mammals/ico_list_prepped.csv'))
...
write_csv(ico_spp_rgn_raw, file.path('circle2016/prep/AO/mammals/ico_spp_rgn_raw.csv'))

ico_spp_rgn_raw <- read_csv(file.path('circle2016/prep/AO/mammals/ico_spp_rgn_raw.csv'))
ico_list <- read_csv(file.path('circle2016/prep/AO/mammals/ico_list_prepped.csv'))
...
write_csv(ico_spp_rgn_prepped, file.path('circle2016/prep/AO/mammals/ico_spp_rgn_prepped.csv'))
...
write_csv(ico_assess_raw, file.path('circle2016/prep/AO/mammals/ico_assessments_raw.csv'))
...
ico_assess_raw <- read_csv(file.path('circle2016/prep/AO/mammals/ico_assessments_raw.csv'))
...
write_csv(ico_assess, file.path('circle2016/prep/AO/mammals/ico_assess_clean.csv'))
...
ico_assess <- read_csv(file.path('circle2016/prep/AO/mammals/ico_assess_clean.csv'))
ico_list <- read_csv(file.path('circle2016/prep/AO/mammals/ico_list_prepped.csv'))
...
write_csv(ico_spp_cat, file.path('circle2016/prep/AO/mammals/ico_spp_cat.csv'))

ico_cat_ts_abbr <- read_csv(file.path('circle2016/prep/AO/mammals/ico_spp_cat.csv')) %>%
  select(iucn_sid, sciname, year, cat, cat_score) %>%
  filter(year >= 2000)

ico_spp_rgn <- read_csv(file.path('circle2016/prep/AO/mammals/ico_spp_rgn_prepped.csv')) %>%
...
write_csv(ico_spp_rgn_cat, file.path('circle2016/prep/AO/mammals/ico_spp_rgn_cat.csv'))

### Report and summarize estimate of regional iconic species status

ico_spp_rgn_cat <- read_csv(file.path('circle2016/prep/AO/mammals/ico_spp_rgn_cat.csv'))
...
write_csv(ico_sum, file.path('circle2016/prep/AO/mammals/ico_summary.csv'))
...
write_csv(ico_status_raw1, file.path('circle2016/prep/AO/output/ao_mammals_iucn_status.csv'))
write_csv(ico_status_calc, file.path('circle2016/prep/AO/output/ao_mammals_status_calc.csv'))
write_csv(ico_trend,       file.path('circle2016/prep/AO/output/ao_mammals_trend.csv'))
